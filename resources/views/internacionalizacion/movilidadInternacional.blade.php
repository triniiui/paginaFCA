    ...
    <div class="row text-center">
        <div class="col-md-4 mb-3">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    <i class="bi bi-airplane-fill fs-1" style="color: #002E5F;"></i>
                    <h5 class="fw-bold mt-2" style="color: #002E5F;">Movilidad Presencial</h5>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    <i class="bi bi-laptop fs-1" style="color: #002E5F;"></i>
                    <h5 class="fw-bold mt-2" style="color: #002E5F;">Movilidad en Línea</h5>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    <i class="bi bi-briefcase-fill fs-1" style="color: #002E5F;"></i>
                    <h5 class="fw-bold mt-2" style="color: #002E5F;">Prácticas Profesionales</h5>
...
<div class="container my-5">
    ...
    <div class="card shadow-sm mb-5">
        <div class="card-body">
            ...
            <h5 class="fw-bold mt-4" style="color: #002E5F;">Requisitos principales:</h5>
            <ul>
            ...
            <h5 class="fw-bold mt-4" style="color: #002E5F;">Ejemplos de fechas:</h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped align-middle">
                    <thead class="table-primary">
                        <tr>
                            <th style="background-color: #002E5F; color: white;">Universidad</th>
                            <th style="background-color: #002E5F; color: white;">Fecha Máx recepción Doctos Inst. Destino</th>
                            <th style="background-color: #002E5F; color: white;">15 días hábiles previos</th>
                            <th style="background-color: #002E5F; color: white;">Fecha Máx. FCA/UADY</th>
                            <th style="background-color: #002E5F; color: white;">Fecha inicio de trámite FCA</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
            ...
            <h5 class="fw-bold mt-4" style="color: #002E5F;">Convocatoria Internacional – North Island College (Canadá)</h5>
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <h6 class="fw-bold" style="color: #002E5F;">Emerging Leaders in the Americas (ELAP) – 2026/27</h6>
                    <p>
                    ...
                    <h6 class="fw-bold mt-3" style="color: #002E5F;">Beca y duración</h6>
                    <p>
                    ...
                    <h6 class="fw-bold mt-3" style="color: #002E5F;">Requisitos</h6>
                    <ul>
                    ...
                    <h6 class="fw-bold mt-3" style="color: #002E5F;">Documentos a enviar</h6>
                    <ul>
...
<div class="container my-5">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <h6 class="fw-bold mt-4" style="color: #002E5F;">Proceso de nominación</h6>
            <p>
            ...
            <h6 class="fw-bold mt-4" style="color: #002E5F;">Recursos adicionales</h6>
            <p>
            ...
            <h6 class="fw-bold mt-4" style="color: #002E5F;">Guías y materiales</h6>
            <ul>
    ...
    <div class="row g-4">
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <h5 class="fw-bold" style="color: #002E5F;">Convocatorias</h5>
                    <ul>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <h5 class="fw-bold" style="color: #002E5F;">Comprobantes de idiomas</h5>
                    <ul>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <h5 class="fw-bold" style="color: #002E5F;">Instituciones y oferta académica</h5>
                    <ul>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <h5 class="fw-bold" style="color: #002E5F;">Boletín de Becas</h5>
                    <ul>
