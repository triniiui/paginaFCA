...
{{--cuadradoooos--}}
    <div class="container text-black">
        <h2 id="nuestros-valores" class="fw-bold mb-4 text-center" style="color: #002E5F;">Nuestros valores</h2>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <h2 id="proceso-ingreso-licenciatura" class="fw-bold mb-4" style="color: #002E5F;">Proceso de Ingreso a Licenciatura</h2>
