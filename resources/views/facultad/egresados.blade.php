...
<div class="container my-5">
    <div class="text-center mb-5">
        <h3 id="coordinacion-seguimiento-egresados" class="fw-bold" style="color: #002E5F;">Coordinación de Seguimiento a Egresados</h3>
...
<section class="py-5">
    <div class="container">
        ...
        <h2 id="guias-tramites-titulacion" class="fw-bold mb-4" style="color: #002E5F;">Guías para realizar los Trámites de Titulación</h2>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <h2 id="sistema-virtual-citas" class="fw-bold mb-4" style="color: #002E5F;">Sistema Virtual de Citas</h2>
