<footer class="bg-uady-blue text-white pt-5 pb-3 mt-5">
    <div class="container">
        <div class="row gy-4">
            <div class="col-md-4 text-center text-md-start">
                <h6 class="fw-bold">Facultad de Contaduría y Administración</h6>
               
                <ul class="list-unstyled small">
                    <li><a href="https://uady.mx/assets/AvisoPrivacidadCamarasSeguridad.pdf" class="text-white text-decoration-none opacity-75 hover-opacity-100">Aviso de Privacidad</a></li>
                    <li><a href="https://transparencia.uady.mx/" class="text-white text-decoration-none opacity-75 hover-opacity-100">Transparencia</a></li>
                </ul>
            </div>

            <div class="col-md-4 text-center">
                 <p class="small opacity-75">Universidad Autónoma de Yucatán</p>
                <p class="small opacity-75">Todos los Derechos Reservados</p>
                <p class="small"><i class="bi bi-envelope-fill me-2"></i> fca@correo.uady.mx</p>
            </div>
