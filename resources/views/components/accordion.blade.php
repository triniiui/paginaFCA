...
<style>
    /* Color amarillo cuando está desplegado (NO collapsed) */
    ...
    /* Color amarillo al hacer hover cuando está desplegado */
    .accordion-button:not(.collapsed):hover {
        background-color: #b58e1d !important;
    }

    /* Quita el ícono por defecto de Bootstrap o cámbialo de color */
    .accordion-button:not(.collapsed)::after {
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23ffffff'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e") !important;
    }

    /* Color del ícono cuando está colapsado (opcional, para que combine) */
    ...
    /* Borde amarillo alrededor del item cuando está abierto */
